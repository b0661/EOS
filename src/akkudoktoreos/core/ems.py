...
class EnergyManagement(
    ...
    async def run(
        ...
        genetic0_individuals: Optional[int] = None,
        ...
        Args:
            ...
            genetic0_parameters (Genetic0OptimizationParameters, optional): The
                ...
                be constructed based on the current configuration and predictions.
            genetic0_individuals (int, optional): The number of individuals for the
        ...
        async with EnergyManagement._run_lock:
            ...
            # --- GENETIC0 algorithm ---
                ...
                # Take values from config if not given
                if genetic0_individuals is None:
                    genetic0_individuals = self.config.optimization.genetic0.individuals
